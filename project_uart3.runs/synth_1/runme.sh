...
HD_PWD='D:/0FPGA/project_FPGA_UART_BRAM/project_uart3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_200MHZ_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_200MHZ_wrapper.tcl
