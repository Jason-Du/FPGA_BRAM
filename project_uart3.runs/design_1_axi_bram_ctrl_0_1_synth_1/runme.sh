...
HD_PWD='D:/0FPGA/project_FPGA_UART_BRAM/project_uart3.runs/design_1_axi_bram_ctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_bram_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_bram_ctrl_0_1.tcl
