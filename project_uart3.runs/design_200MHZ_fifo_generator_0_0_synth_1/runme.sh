...
HD_PWD='D:/0FPGA/project_FPGA_UART_BRAM/project_uart3.runs/design_200MHZ_fifo_generator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_200MHZ_fifo_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_200MHZ_fifo_generator_0_0.tcl
